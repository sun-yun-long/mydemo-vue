 ...
 * @Description: 
 * @Author: 
 * @Date: 2024-10-18 10:07:44
 * @LastEditors: Please set LastEditors
 * @LastEditTime: 2024-10-18 13:15:09
-->
<template>
  <div>
    <!-- 网页内容部分 -->
    <div class="shell">
      ...
      <div class="card">
        ...
        <div class="wrapper">
          <!-- 卡片封面图片 -->
          <img src="@/assets/logo.png" alt="" class="cover-image" />
        </div>
        <!-- 卡片标题文本 -->
        <!-- <img src="@/assets/logo.png" alt="" class="title" /> -->
        <div class="title">Keep love forever</div>
        <!-- 卡片角色图片 -->
        <img src="@/assets/img/img1.webp" alt="" class="character" />
      </div>
      ...
      <div class="card">
        ...
        <img src="@/assets/logo.png" alt="" class="title" />
        <!-- 卡片角色图片 -->
        <img src="@/assets/img/img2.webp" alt="" class="character" />
      </div>
    </div>
  </div>
</template>
